# Моделированние системы управления инвестиционным портфелем
...
Данный проект является практической работой по информатике, выданной в **АНОО "Физтех-лицее" им. П.Л. Капицы** в 11-ом классе.
...
2. [Краткая характеристика пользовательского интерфейса](doc/interfacedoc.md)
